...
## 🛠 Open Source
- **EmbedSelect** – AI-driven text embedding model selector for optimal performance.

---

## 📜 Patents
- Generating training/testing data for face recognition (US Patent App. 2025)  
- Image distortion quantification and automatic controls (2024–2025)  
- Dynamic algorithm selection for sustainable travel solutions  
